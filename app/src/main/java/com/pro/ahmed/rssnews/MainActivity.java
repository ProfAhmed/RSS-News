...
public class MainActivity extends AppCompatActivity
    ...
    RssSourcesViewModel rssSourcesViewModel;
...
//        rssSourcesViewModel.getListRssSources().observe(this, new Observer<List<RssSourcesModel>>() {
//            @Override
//            public void onChanged(@Nullable List<RssSourcesModel> rssSourcesModels) {
//                String sources = "";
//                for (int i = 0; i < rssSourcesModels.size(); i++) {
//                    Log.v("RssSource", rssSourcesModels.get(i).getRssName() + " " + i);
//                    textView.append(rssSourcesModels.get(i).getRssName() + " " + i);
...
//        });
        ...
        newsViewModel.getListNews().observe(MainActivity.this, new Observer<List<NewsModel>>() {
            @Override
